...
namespace XafMoralisMetamaskAuth.Blazor.Server {
    public partial class XafMoralisMetamaskAuthBlazorApplication : BlazorApplication {
        public XafMoralisMetamaskAuthBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XafMoralisMetamaskAuthBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
